...
# Pad images with 0s
x_train = np.pad(x_train, ((0, 0), (2, 2), (2, 2), (0, 0)), 'constant') # padding: for each dimension, padding values in left or right direction. Here padding in horizantal & vertical axis
